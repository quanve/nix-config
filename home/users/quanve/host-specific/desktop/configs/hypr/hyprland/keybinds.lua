...
create_bind(vars.kbOverview, hl.dsp.global("caelestia:showall"))
...
create_bind(vars.kbSetWallpaper, hl.dsp.exec_cmd("/home/quanve/.config/hypr/switch_wallpaper.sh set"))
create_bind(vars.kbQuit, hl.dsp.exit())
